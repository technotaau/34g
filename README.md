...
| `docs/census-village-list-findings.md` | The finding: 28 populated villages of 1951 vanish by 2011, lie inside the range on the 1955 map, and their area matches the range. |
